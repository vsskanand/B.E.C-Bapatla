...
namespace AppStudio
{
    ...
    {
        public const string APP_NAME = "B.E.C Bapatla";
        ...
        {
            TileServices.CreateFlipTile(@"B.E.C, Bapatla", @"Bapatla Engineering College", @"DataImages/FlipSquareTile.jpg", "DataImages/FlipWideTile.jpg");
        }
        #endregion
    }
}
